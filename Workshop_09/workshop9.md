...
Practitioners have developed a set of tools to manage secrets. One of the most popular tool is Hashicorp Vault that helps practitioners in managing secrets programmatically. We will be using the open source version of Hashicorp Vault (HCP Vault) to store and retrieve secrets.

In-class Hands-on Experience
We will be following an existing tutorial provided by HCP Vault.
...
We will use an API called HVAC
